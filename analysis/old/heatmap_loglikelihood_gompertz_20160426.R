...
#sd of gaussian noise function
 calculate.noise = function(beta,alpha){
  ...
  gaussian<-rnorm(N, mean = 0, sd = 3*mean(inverse.gomp.CDF))
  #observation
...
#}
  ...
  #jpeg(file = "~/github/model.comparison/plotsGompertz/Heatplot_[0.5,1.5].jpeg")
  ...
  heatmap.2(data_mat,dendrogram = "none",
            ...
            key        = TRUE,
            labRow     = NA,  
            ylab     = "delta_log-likelihood of W-G, parameter range is [0.5,1.5]",
            xlab     = "noise",
