...
write.csv(new_fit,"conditionsWeibRedo_emine_09212016.csv")
new_fit<-read.csv("conditionsWeibRedo_emine_09212016.csv")
...
hist(as.numeric(WT.BY4742.media$AvgLS),xlab="Mean Lifespan",main="Wild type: BY4742",
     breaks=length(as.numeric(WT.BY4742.media$AvgLS)),col="gray",xlim=c(10,40),ylim=c(0,15))


hist(as.numeric(WT.BY4742.media$gompShape),xlab="G shape parameters",main="",
     breaks=length(as.numeric(WT.BY4742.media$gompShape)),col="blue",xlim=c(0,0.16),ylim=c(0,15))

hist(as.numeric(WT.BY4742.media$gompRate),xlab="R rate parameters",main="",
     breaks=length(as.numeric(WT.BY4742.media$gompRate)),col="green",xlim=c(0,0.07),ylim=c(0,20))
dev.off()
...
hist(as.numeric(WT.BY4741.media$AvgLS),xlab="Mean Lifespan",main="Wild type: BY4741",
     breaks=length(as.numeric(WT.BY4741.media$AvgLS)),col="gray",xlim=c(15,40),ylim=c(0,6))


hist(as.numeric(WT.BY4741.media$gompShape),xlab="G shape parameters",main="",
     breaks=length(as.numeric(WT.BY4741.media$gompShape)),col="blue",xlim=c(0.05,0.17),ylim=c(0,8))

hist(as.numeric(WT.BY4741.media$gompRate),xlab="R rate parameters",main="",
     breaks=length(as.numeric(WT.BY4741.media$gompRate)),col="green",xlim=c(0,0.02),ylim=c(0,8))
dev.off()
...
hist(as.numeric(WT.BY4743.media$AvgLS),xlab="Mean Lifespan",main="Wild type: BY4743",
     breaks=length(as.numeric(WT.BY4743.media$AvgLS)),col="gray",xlim=c(25,45),ylim=c(0,4))


hist(as.numeric(WT.BY4743.media$gompShape),xlab="G shape parameters",main="",
     breaks=length(as.numeric(WT.BY4743.media$gompShape)),col="blue",xlim=c(0.05,0.15),ylim=c(0,4))
